...
int main() {
    ...
    for (int currentSeed = 2; currentSeed < stoi(seedNum); currentSeed++) {
      ...
      string fileName = "../data/" + to_string(currentSeed) + "_rolls.txt";
